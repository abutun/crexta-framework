...
namespace abbSolutions.Communication.HyperTypeDescriptor
{
    sealed class HyperTypeDescriptor : CustomTypeDescriptor {
        private readonly PropertyDescriptorCollection abilityCollections;
        ...
        static HyperTypeDescriptor() {
            AssemblyName an = new AssemblyName("abbSolutions.Communication.HyperTypeDescriptor.dynamic");
            AssemblyBuilder ab = AppDomain.CurrentDomain.DefineDynamicAssembly(an, AssemblyBuilderAccess.Run);
            moduleBuilder = ab.DefineDynamicModule("abbSolutions.Communication.HyperTypeDescriptor.dynamic.dll");
                ...
                lock (properties) {
                    ...
                    if (property.CanRead) {
                        ...
                        if (property.DeclaringType.IsValueType) {
                            // upbox the object parameter into our known (instance) struct type
                            ...
                            // cast the object parameter into our known class type
                            il.Emit(OpCodes.Ldarg_1);
